...
CREATE TABLE `Train` (
  ...
  `Wifi` char(1) NOT NULL DEFAULT 'Y',
  `Food` char(1) NOT NULL DEFAULT 'Y',
  `Run_On_Sunday` char(1) NOT NULL DEFAULT 'Y',
  `Run_On_Monday` char(1) NOT NULL DEFAULT 'Y',
  `Run_On_Tuesday` char(1) NOT NULL DEFAULT 'Y',
  `Run_On_Wednesday` char(1) NOT NULL DEFAULT 'Y',
  `Run_On_Thursday` char(1) NOT NULL DEFAULT 'Y',
  `Run_On_Friday` char(1) NOT NULL DEFAULT 'Y',
  `Run_On_Saturday` char(1) NOT NULL DEFAULT 'Y',
...
CREATE TABLE `Seats` (
  ...
  KEY `Train_No` (`Train_No`),
  CONSTRAINT `Seats_ibfk_2` FOREIGN KEY (`Train_No`) REFERENCES `Train` (`Train_No`) ON UPDATE CASCADE
);
